  ...
  variants: {
    ...
    variant: {
      primary: [
        ...
        // hover color
        "hover:bg-brand-secondary dark:hover:bg-brand-secondary",
        // disabled
        "disabled:bg-brand-primary/50 disabled:text-gray-400",
        "disabled:dark:bg-brand-primary/50 disabled:dark:text-gray-400",
      ],
      secondary: [
        // border
