...
export const focusInput = [
  ...
  "focus:ring-2",
  // ring color
  "focus:ring-brand-primary/20 focus:dark:ring-brand-primary/30",
  // border color
  "focus:border-brand-primary focus:dark:border-brand-primary",
]
...
export const focusRing = [
  ...
  // outline color
  "outline-brand-primary dark:outline-brand-primary",
]
